...
### 🚀 Backend Developer | FinTech Specialist | Payment Systems Expert
...
### 💳 **E-payment Backend Development Senior Specialist** @ Superpay by Etisalat (e&)
*March 2025 – Present | Cairo, Egypt (Hybrid)*
...
*September 2024 – March 2025 | Cairo, Egypt (Hybrid)*
...
*July 2023 – July 2024 | Remote*

- ⚡ Developed RESTful APIs using **Node.js** and **Express.js** for IoT lighting control systems serving international clients
- 🗄️ Integrated **MongoDB** and **SQL** databases, optimizing data retrieval performance for real-time lighting applications
...
![Go](https://img.shields.io/badge/Gin-00ADD8?style=for-the-badge&logo=go&logoColor=white)
...
> RESTful API for comprehensive automotive service management
...
- ✅ **20+ Integration Projects** delivered with payment vendors, completing 95% ahead of schedule
- ⚡ **Optimized payment processing systems** handling increased transaction volume with improved efficiency
- 🎖️ **Performance awards** recognized for rapid integration delivery and system optimization
